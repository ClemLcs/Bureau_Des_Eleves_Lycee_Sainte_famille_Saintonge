<?php echo $__env->yieldContent('header-desktop-html'); ?>
<!-- HEADER DESKTOP-->
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <?php if(Auth::check() === true){
                                            $users = Auth::user();
                                        ?>
                                            <img src="<?php echo e($users->img_profil); ?>" alt="<?php echo e($users->img_profil); ?>" />
                                        <?php } ?> 
                                        </div>
                                        <div class="content">
                                        <?php if(Auth::check() === true){
                                            $users = Auth::user();
                                        ?>
                                            <a class="js-acc-btn" href=""><?php echo e($users->prenom); ?></a>
                                        <?php } ?>
                                        </div>
                                            ...
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <?php if(Auth::check() === true){
                                                        $users = Auth::user();
                                                    ?>
                                                        <a href="#"><?php echo e($users->prenom); ?></a>
                                                    <?php } ?>
                                                    </h5>
                                                    <span class="email">
                                                    <?php
...
</header><?php /**PATH /home/site/bde/resources/views/layouts/body/HTML/Header-desktop.blade.php ENDPATH**/ ?>