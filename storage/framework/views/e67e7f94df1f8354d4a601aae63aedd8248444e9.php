...
<section class="jumbotron text-center" style="width: 100%;top: 76px;">
      <div class="container">
        <h1 class="jumbotron-heading">Message(s) du BDA</h1>
        <p class="lead text-muted">Ici sont affichés les différents messages du BDA ( Bureau des Actions ).</p>
      </div>
</section>
...
<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="col-lg-4 col-md-6 mb-4">
    <div class="card h-100">
      ...
      <div class="card-body">
        <h4 class="card-title">
          <a href="/bda/<?php echo e($post->slug); ?>"><?php echo e($post->title); ?></a>
        </h4>
...
<?php echo $__env->make('layouts.head.HTML.Meta', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/bde/resources/views/bda/index.blade.php ENDPATH**/ ?>