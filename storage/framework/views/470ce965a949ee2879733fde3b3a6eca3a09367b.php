...
<?php $__env->startSection('content'); ?>
        ...
        <div class="caroussel_bootstrap" style="max-width: 90%;left: 16%;position: relative;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="<?php echo e(asset('images/Diapo-8.jpg')); ?>" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo e(asset('images/Diapo-9.jpg')); ?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo e(asset('images/Diapo-3.jpg')); ?>" alt="Third slide">
                </div>
            </div>
        ...
        <div class="msg" style="position: relative;text-align: center;left: 10%;">
            <img src="<?php echo e(asset('images/bureau des eleves.jpg')); ?>" class="msg-expli">
		...
		<div class="content" style="position: relative;text-align: center;left: 10%;">
            <!-- Espace -->
            <div class="images">
                <img src="<?php echo e(asset('svg/espace-famille.svg')); ?>" class="images-espace">
                <h3 class="texte-espace">  Un espace pour tous</h3>
            </div>

            <!-- Multi -->
            <div class="images">
                <img src="<?php echo e(asset('svg/index.svg')); ?>" class="images-multi">
                <h3 class="texte-multi">Compatible sur tous <br> les types de périphériques  </h3>
            </div>

            <!-- Achat -->
            <div class="images">
                <img src="<?php echo e(asset('svg/caddies.svg')); ?>" class="images-caddies">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/bde/resources/views/welcome.blade.php ENDPATH**/ ?>