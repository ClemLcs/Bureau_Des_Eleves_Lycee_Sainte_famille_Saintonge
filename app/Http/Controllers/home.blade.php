...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="images/Sans titre.png" alt="Logo"  height="100px"/>
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="/index.html">
                                <i class="fas fa-tachometer-alt"></i>Page d'accueil</a>
                        </li>
                        <li>
                            <a href="chart.html">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="images/Sans titre.png" alt="Cool Admin" class="img_haut_a_gauche" height="70px" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            if (!Auth::check()) {
                            ?>
                                <a href="/login"><i class="fas fa-desktop"></i>Connexion</a>
                                <a href="/register"><i class="fas fa-desktop"></i>Enregistrement</a>
                            <?php
                            }else{
                            ?>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>Liste des évènements</h3>
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            ...
                                            <?php if(!empty($posts)){?>
                                                ...
                                                <div class="au-task__item au-task__item--warning">
                                                    <div class="au-task__item-inner">
                                                        <h5 class="task">
                                                            <a href="/dashboard/{{$post->name}}">{{$post->name}}</a>
                                                        </h5>
