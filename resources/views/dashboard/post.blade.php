...
<body class="animsition" style="animation-duration: 900ms; opacity: 1;">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('images/Sans titre.png')}}" alt="Logo"  height="100px"/>
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('images/Sans titre.png')}}" alt="Cool Admin" class="img_haut_a_gauche" height="70px" />
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            ?>
                                ...
                                <a href="/register"><em class="fas fa-desktop"></em>Enregistrement</a>
                            <?php
                            }else{
                            ?>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <?php if(!empty($users)){?>
                                                <img src="{{Auth::user()->img_profil }}" alt="{{Auth::user()->img_profil }}" />
                                            <?php }else{ ?>
                                                <img src="" alt="{{$users->img_profil }}" />
                                            <?php }?>
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{Auth::user()->prenom}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{Auth::user()->prenom}}</a>
                                                    </h5>
                                                    <span class="email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cda7a2a5a3a9a2a88da8b5aca0bda1a8e3aea2a0">{{Auth::user()->email}}</a></span>
                                                </div>
                                            </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row m-t-25">
                            <h2><?php $posts = App\Post::find($posts); ?></h2>
                            <?php dd($posts); ?>
                            <!-- <p>{{ $posts->content}}</p>
                            <p>{{ $posts->id}}</p> -->
                        </div>
